...
//CVS:          $Id: PositionListDlg.java 8744 2012-02-14 20:47:46Z henry $
...
public class PositionListDlg extends MMDialog implements MouseListener {
   ...
   public PositionListDlg(CMMCore core, ScriptInterface gui, 
      ...
      springLayout.putConstraint(SpringLayout.SOUTH, scrollPane, -123, SpringLayout.SOUTH, getContentPane());
      getContentPane().add(scrollPane);

      final JScrollPane axisPane = new JScrollPane();
      springLayout.putConstraint(SpringLayout.NORTH, axisPane, 22, SpringLayout.SOUTH, scrollPane);
      ...
      posTable_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      axisTable_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      markButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      gotoButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      setOriginButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      removeAllButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      springLayout.putConstraint(SpringLayout.NORTH, closeButton, 513, SpringLayout.NORTH, getContentPane());
      springLayout.putConstraint(SpringLayout.SOUTH, closeButton, -10, SpringLayout.SOUTH, getContentPane());
      ...
      springLayout.putConstraint(SpringLayout.NORTH, tileButton, 486, SpringLayout.NORTH, getContentPane());
      tileButton.setFont(new Font("sansserif", Font.PLAIN, 10));
