...
public class MMIntroDlg extends JDialog {
   ...
   public MMIntroDlg(String ver, ArrayList<String> mruCFGFileList) {
      ...
      version10betaLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      loadConfigurationLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      cfgFileDropperDown_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      welcomeTextArea_.setFont(new Font("sansserif", Font.PLAIN, 10));
