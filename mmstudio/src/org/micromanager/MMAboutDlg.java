...
public class MMAboutDlg extends JDialog {
   ...
   public MMAboutDlg() {
      ...
      openSourceAutomatedLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      citeUs.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      versionInfo_.setFont(new Font("sansserif", Font.PLAIN, 10));
