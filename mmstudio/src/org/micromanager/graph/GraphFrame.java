...
public class GraphFrame extends MMFrame {
   ...
   public GraphFrame() {
      ...
      xMinLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      xMinLabel_1.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      xMinLabel_2.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      xMinLabel_1_2.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      btnAutoscale.setFont(new Font("sansserif", Font.PLAIN, 10));
