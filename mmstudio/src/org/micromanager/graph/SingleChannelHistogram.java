...
public class SingleChannelHistogram extends JPanel implements Histograms, CursorListener {
   ...
   private void initGUI() {
      ...
      fullScaleButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      autoScaleButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      histRangeLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
