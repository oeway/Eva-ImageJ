...
//
// CVS:          $Id: OptionsDlg.java 9545 2012-06-08 18:17:04Z henry $
...
public class OptionsDlg extends MMDialog {
   ...
   public OptionsDlg(MMOptions opts, CMMCore core, Preferences mainPrefs, ScriptInterface parent, String cfgPath) {
      ...
      //displayLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      comboDisplayBackground_.setFont(new Font("sansserif", Font.PLAIN, 10));
