...
public class CustomTimeIntervalsPanel extends JPanel {
    ...
    private void createButtons() {       
        ...
        createLinearTimePointsButton.setFont(new Font("sansserif", Font.PLAIN, 10));
        ...
        createLogTimePointsButton.setFont(new Font("sansserif", Font.PLAIN, 10));
    ...
    private class LogTimeDialog extends MMDialog {
       ...
       private int n_;
        ...
        private void createCheckBoxes() {
            ...
            aValue_.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            aCombo_.setFont(new Font("sansserif", Font.PLAIN, 14));
            row1.add(aValue_);
            row1.add(aCombo_);
            rValue_ = new JFormattedTextField(NumberFormat.getNumberInstance());
            rValue_.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            tValue_.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            tCombo_.setFont(new Font("sansserif", Font.PLAIN, 14));
            row3.add(tValue_);
            row3.add(tCombo_);
            ...
            ((JSpinner.DefaultEditor) nValue_.getEditor()).getTextField().setFont(new Font("sansserif", Font.PLAIN, 14));
            row1.add(nValue_);
            row4.add(nValue_);
       ...
       ArrayList<Double> newIntervals = new ArrayList<Double>();
        ...
        private void createCreationComboandButtons() { 
            ...
            creationTypeCombo_.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            createButton.setFont(new Font("sansserif", Font.PLAIN, 14));
    ...
    private class LinearTimeDialog extends MMDialog {
        ...
        private void initComponents() {
            ...
            ((JSpinner.DefaultEditor) numFrames_.getEditor()).getTextField().setFont(new Font("sansserif", Font.PLAIN, 14));
            row1.add(numFrames_);
            ...
            intervalLabel.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            interval_.setFont(new Font("sansserif", Font.PLAIN, 14));
            ...
            timeUnitCombo_.setFont(new Font("sansserif", Font.PLAIN, 14));
