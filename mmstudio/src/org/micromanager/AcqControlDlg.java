...
public class AcqControlDlg extends JFrame implements PropertyChangeListener {
   ...
   public AcqControlDlg(AcquisitionEngine acqEng, Preferences prefs, ScriptInterface gui) {
      ...
      overrideLabel.setFont(new Font("sansserif", Font.BOLD, 12));
      ...
      disableCustomIntervalsButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      numberLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      ((JSpinner.DefaultEditor) numFrames_.getEditor()).getTextField().setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      intervalLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      interval_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      timeUnitCombo_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zbottomLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zBottom_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      ztopLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zTop_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zstepLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zStep_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zValCombo_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      stackKeepShutterOpenCheckBox_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      summaryTextArea_.setFont(new Font("sansserif", Font.PLAIN, 11));
      ...
      ((JSpinner.DefaultEditor) afSkipInterval_.getEditor()).getTextField().setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      channelsLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      channelTablePane_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      upButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      downButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      chanKeepShutterOpenCheckBox_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      displayMode_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      acquireButton.setFont(new Font("sansserif", Font.BOLD, 12));
      ...
      loadButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      saveAsButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      advancedButton.setFont(new Font("sansserif", Font.PLAIN, 10));
