...
//CVS:          $Id: MMStudioMainFrame.java 9556 2012-06-12 03:06:33Z arthur $
//
...
import i18n.JCheckBoxMenuItem;
import javax.swing.JComboBox;
import javax.swing.JFrame;
import i18n.JLabel;
import i18n.JMenu;
import javax.swing.JMenuBar;
import i18n.JMenuItem;//import javax.swing.JMenuItem;
import javax.swing.JOptionPane;
import javax.swing.JTextField;
import i18n.JToggleButton;
...
public class MMStudioMainFrame extends JFrame implements ScriptInterface, DeviceControlGUI {
 ...
 public void checkSimpleAcquisition(TaggedImage image) {
   ...
   public MMStudioMainFrame(boolean pluginStatus) {
      ...
      //buttonSnap_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      textFieldExp_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      toggleButtonLive_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      toAlbumButton_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      toggleButtonShutter_.setFont(new Font("sansserif", Font.BOLD, 10));
      ...
      activeShutterLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      binningLabel.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      comboBinning_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      cameraSettingsLabel.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      labelImageDimensions_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      stateDeviceLabel.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      buttonAcqSetup.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      autoShutterCheckBox_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      citePleaLabel.setFont(new Font("sansserif", Font.PLAIN, 11));
      ...
      setRoiButton_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      clearRoiButton_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      regionOfInterestLabel.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      regionOfInterestLabel_1.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      zoomInButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      zoomOutButton.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      profileLabel_.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      buttonProf.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      autofocusLabel_.setFont(new Font("sansserif", Font.BOLD, 11));
      ...
      buttonAutofocus_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      buttonAutofocusTools_.setFont(new Font("sansserif", Font.PLAIN, 10));
...
//      acqMgr_.getAcquisition(acqName).setSystemState(md);
   ...
   private void loadPlugins() {
      ...
      try {
         ...
         classes = JavaUtils.findClasses(new File("mmplugins"), 2);//"C:\\Program Files\\Micro-Manager-1.4\\mmplugins"
