...
public class ConfigDialog extends MMDialog {
   ...
   protected void initializeWidgets() {
      ...
      textArea_.setFont(new Font("sansserif", Font.PLAIN, 12));
      ...
      if (showShowReadonlyCheckBox_) {
         ...
         showReadonlyCheckBox_.setFont(new Font("sansserif", Font.PLAIN, 10));
      ...
      nameFieldLabel_.setFont(new Font("sansserif",Font.BOLD,12));
   ...
   public void initializePropertyTable() {
        ...
        scrollPane_.setFont(new Font("sansserif", Font.PLAIN, 10));
