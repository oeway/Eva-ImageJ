...
#define defaults_h
...
#ifdef DEFAULTS_EVA_NDE
  // Grbl default settings for EVA_NDE.
  #define DEFAULT_X_STEPS_PER_MM 55.526
  #define DEFAULT_Y_STEPS_PER_MM 55.410
  #define DEFAULT_Z_STEPS_PER_MM 88.655
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_MM_PER_ARC_SEGMENT 0.1
  #define DEFAULT_RAPID_FEEDRATE 7000.0 // mm/min
  #define DEFAULT_FEEDRATE 5000.0
  #define DEFAULT_ACCELERATION (300.0*60*60) // 300 mm/min^2
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  ...
  #define DEFAULT_HOMING_DIR_MASK ((1<<Y_DIRECTION_BIT)|(1<<X_DIRECTION_BIT)) // move positive dir
  #define DEFAULT_HOMING_RAPID_FEEDRATE 3000.0 // mm/min
  #define DEFAULT_HOMING_FEEDRATE 800.0 // mm/min
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 200 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 80.0 // mm
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-255)
  #define DEFAULT_DECIMAL_PLACES 3
  #define DEFAULT_N_ARC_CORRECTION 25
#endif
