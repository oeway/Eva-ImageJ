...
#define defaults_h
  ...
  #define DEFAULT_X_STEPS_PER_MM 277.630
  #define DEFAULT_Y_STEPS_PER_MM 354.621
  #define DEFAULT_Z_STEPS_PER_MM 250.0
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_MM_PER_ARC_SEGMENT 0.1
  #define DEFAULT_RAPID_FEEDRATE 1500.0 // mm/min
  #define DEFAULT_FEEDRATE 1000.0
  #define DEFAULT_ACCELERATION (70.0*60*60) // 10 mm/min^2
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  ...
  #define DEFAULT_HOMING_RAPID_FEEDRATE 1800.0 // mm/min
